...
AIS_DAMAGE_TOLLERANCE_FACTOR = 	0.7; 				// A higher value means more damage tolerance. 1 is Vanilla. 0.8 mean all damage will reduce to 80% of Vanilla.
...
AIS_REVIVETIME 				= 	25;				// Basic revive time in seconds. The real revive time depends on the real damage of the unit. (can be less or more time from the basic value)
