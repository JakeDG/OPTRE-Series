...
[ phoenix, 
	...
	[["clearTask_1", "primTasks"], "<img image='images\factory_1.jpg' width='370' height='208'/><br/><br/><font color='#469CED'>Clear</font> the <marker name='factoryMkr'>Traxus factory</marker> of insurrectionists.", "Retake Traxus Factory", "",getMarkerPos "factoryMkr", "assigned", "attack"],
	
	[["bombTask", "primTasks"], "<img image='images\bomb.jpg' width='370' height='208'/><br/><br/>Locate and <font color='#469CED'>diffuse</font> all of the insurrectionist <font color='#469CED'>explosive devices</font> in the <marker name='factoryMkr'>Traxus factory</marker>.","Defuse Bombs","","","interact"]
...
[ phoenix,
	...
	["Supports", "<img image='images\vehicles.jpg' width='370' height='208'/><br/><br/><font color='#469CED'>No Air support could be granted at this time.</font><br/>However, feel free to use the vehicles at FOB Sierra to accomplish you mission."],
	
	["Signal", "<font color='#469CED'>Phoenix</font> - Your team<br/><br/><font color='#469CED'>Command</font> - HQ"],
	
	["Bombs", "<img image='images\bomb.jpg' width='370' height='208'/><br/><br/>Scouts have reported that the Innies are <font color='#469CED'>using the ordnance from the factory</font> to make bombs. They believe the bombs are <font color='#469CED'>placed in the major buidlings of the complex</font>, but are not entirely sure. If you find any of these bombs, make sure to <font color='#469CED'>disarm them immediately</font>!"],
	
	["Team Abilities", " - The members of Phoenix Team are equipped with ODST armor that can <font color='#469CED'>take 30% more damage</font> than standard marine armor.<br/><br/>- They can also carry <font color='#469CED'>25% more gear</font> than the standard soldier because of their extreme conditioning."],
