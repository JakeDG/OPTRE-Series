...
["<t  size = '1.0'>A few hours after the attack...</t>", safeZoneX+0.45, safeZoneY+safeZoneH-0.85, 4, 4, 0, 600] spawn BIS_fnc_dynamicText;
sleep 10.0;

["<t size='1.0' color='#2B7ADA'>AlphaDog Presents...</t>", safeZoneX+0.45, safeZoneY+safeZoneH-0.85, 4, 4, 0, 600] spawn BIS_fnc_dynamicText;
sleep 10.0;
